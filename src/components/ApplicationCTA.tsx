...
export const ApplicationCTA: React.FC<ApplicationCTAProps> = ({
  ...
  return (
    <section id="apply-now" className="py-16 sm:py-20 bg-[#060B19] text-white border-t border-b border-slate-800 scroll-mt-24">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        
        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-slate-900 border border-slate-700/80 text-amber-400 text-xs font-semibold tracking-wide mb-6">
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
          ...
          <button
            ...
            className="px-6 py-4 rounded-xl text-xs sm:text-sm font-semibold tracking-wide text-white bg-slate-900 hover:bg-slate-800 border border-slate-700 transition-colors flex items-center gap-2 cursor-pointer"
          >
