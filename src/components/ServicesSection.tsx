        ...
        {viewMode === 'interactive' && (
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
            ...
            <div className="lg:col-span-7">
              <div className="p-6 sm:p-8 rounded-3xl bg-white border border-sky-200 shadow-lg text-left space-y-6">
        ...
        {viewMode === 'grid' && (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 text-left">
            {CORE_SERVICES.map((service) => (
              <div
                key={service.id}
                className="p-6 rounded-3xl bg-white border border-sky-200 shadow-sm flex flex-col justify-between hover:border-blue-500 hover:shadow-lg transition-all duration-300 group"
              >
