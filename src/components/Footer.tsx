...
export const Footer: React.FC<FooterProps> = ({
  ...
  const quickLinks = [
    ...
    { label: 'Study in India', href: '#why-india' },
    { label: 'Services', href: '#services' },
    { label: 'Universities', href: '#explorer' },
          ...
          <div className="lg:col-span-4 space-y-4">
            ...
            <div className="pt-2">
              <button
                ...
                className="px-4 py-2 rounded-xl text-xs font-bold uppercase tracking-wider text-slate-950 bg-amber-400 hover:bg-amber-300 transition-colors inline-flex items-center gap-1.5 cursor-pointer"
              >
          ...
          <div className="lg:col-span-3 space-y-3">
            ...
            <ul className="space-y-2 text-xs text-slate-400">
              {quickLinks.map((link) => (
                <li key={link.label}>
                  <a
                    ...
                    className="hover:text-amber-400 transition-colors cursor-pointer block py-0.5"
                  >
                    {link.label}
                  </a>
                </li>
              ...
              <li>
                <button
                  onClick={onOpenApplication}
                  className="hover:text-amber-400 transition-colors cursor-pointer text-left py-0.5 font-semibold text-slate-300"
                >
              ...
              <li>
                <button
                  ...
                  className="hover:text-amber-400 transition-colors cursor-pointer text-left py-0.5 text-slate-400"
                >
                  Student Portal (Track Application)
                </button>
              </li>
            </ul>
          </div>
          ...
          <div className="lg:col-span-5 space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs">
              {OFFICIAL_EMAIL_DIRECTORY.map((contact) => (
                <div key={contact.email} className="p-2 rounded-lg bg-slate-900/60 border border-slate-800">
