...
// Interactive particle & travelling stroke button component
...
export function StarfieldButton(props: StarfieldButtonProps) {
    const {
        ...
        glow = { size: 14, color: "#38bdf8", opacity: 90 },
        stroke = {
            size: 80,
            color: "#38bdf8",
            count: 2,
        ...
        pixel = { size: 4, color: "#38bdf8", density: 50, brightness: 100 },
        link = "",
        transition = { ease: [0.44, 0, 0.56, 1], type: "tween", delay: 0, duration: 0.45 },
        newTab = false,
        style,
    } = props

    const fill = colors?.fill ?? fillProp ?? "#0f172a"
    const textColor = colors?.textColor ?? textColorProp ?? "#FFFFFF"

    const {
        color: glowColor = "#38bdf8",
        size: glowSize = 14,
    ...
    return (
        ...
        >
            <Tag
                ...
                onPointerDown={() => !disabled && scaleTo(0.97)}
                onPointerUp={() => !disabled && scaleTo(1)}
                style={{
            ...
            >
                ...
                <span
                    ...
                    style={{
                        ...
                        gap: (hasIcon || children) && showText ? gap : 0,
                        flexDirection:
